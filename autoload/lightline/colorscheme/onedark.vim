...
let s:white = [ '#BCB2A0', s:term_white ]
let s:black = [ s:colors.black.gui, s:term_black ]
let s:black2 = [ s:colors.cursor_grey.gui, s:term_grey ]
let s:grey = [ s:colors.visual_grey.gui, s:term_grey ]
let s:grey2 = [ s:colors.comment_grey.gui, s:term_grey ]

let s:p = {'normal': {}, 'inactive': {}, 'insert': {}, 'replace': {}, 'visual': {}, 'tabline': {}}
let s:p.normal.left = [ [ s:black, s:white ], [ s:white, s:grey ] ]
...
let s:p.replace.left = [ [ s:black, s:purple ], [ s:white, s:grey ] ]
let s:p.replace.right = [ [ s:black, s:purple ], [ s:white, s:grey ] ]
let s:p.visual.left = [ [ s:black, s:yellow ], [ s:white, s:grey ] ]
let s:p.visual.right = [ [ s:black, s:yellow ], [ s:white, s:grey ] ]
let s:p.normal.middle = [ [ s:grey2, s:black ] ]
let s:p.inactive.middle = [ [ s:white, s:grey ] ]
let s:p.tabline.left = [ [ s:grey2, s:black2 ] ]
